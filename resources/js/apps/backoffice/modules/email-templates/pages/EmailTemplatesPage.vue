    ...
    <div class="space-y-6">
        <div>
            ...
            <p class="mt-2 text-slate-400">
                Pas de automatische e-mails aan die verstuurd worden bij een reservatie.
                De standaardteksten worden bepaald door PlayDrive, maar je kan ze hier volledig naar eigen hand zetten.
            </p>
        </div>
...
import EmailTemplateEditModal from './EmailTemplateEditModal.vue'
import { fetchEmailTemplates, previewEmailTemplate, resetEmailTemplate, updateEmailTemplate } from '../services/emailTemplateApi'
