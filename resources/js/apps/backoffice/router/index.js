...
import TenantSettingsPage from '../modules/tenant-settings/pages/TenantSettingsPage.vue'
...
const routes = [
    ...
    { path: '/tenant-settings', name: 'backoffice.tenant-settings', component: TenantSettingsPage },
]
