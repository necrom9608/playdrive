...
<div class="preview-stack">
    <div class="preview-meta">
        ...
        <span>PNG render · {{ (int) ($template['width'] ?? 1016) }} × {{ (int) ($template['height'] ?? 638) }} px</span>
    </div>

    <div class="print-sheet">
        <canvas id="renderCanvas" class="render-canvas" width="{{ (int) ($template['width'] ?? 1016) }}" height="{{ (int) ($template['height'] ?? 638) }}"></canvas>
