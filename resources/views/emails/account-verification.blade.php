...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; background: linear-gradient(180deg, #06b6d4 0%, #0891b2 100%); color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 600; padding: 14px 32px; border-radius: 12px; }
    ...
    <div class="card">
        ...
        <div class="body">
            ...
            @else
                ...
                <p class="text">
                    Welkom bij{{ $tenantName ? ' ' . $tenantName : '' }}!
                    Klik op de knop hieronder om je e-mailadres te bevestigen en je account te activeren.
                </p>

                <p class="text">
                    De link is <strong>24 uur geldig</strong>.
                </p>

                <div class="btn-wrap">
                    <a href="{{ $verifyUrl }}" class="btn">E-mailadres bevestigen</a>
                </div>
                ...
                <p class="note">
                    Als je geen account hebt aangemaakt, kan je deze mail veilig negeren.
                </p>
            @endif
        </div>
