...
export const usePosStore = defineStore('pos', {
    ...
    actions: {
        ...
        async checkoutCurrentOrder(payload = {}) {
            ...
            const canCheckOutReservationWithoutItems = Boolean(this.selectedReservationId) && !items.length

            if (!items.length && !canCheckOutReservationWithoutItems) {
            ...
            try {
                if (canCheckOutReservationWithoutItems) {
