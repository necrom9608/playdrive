                ...
                <form class="flex min-h-0 flex-col p-6" @submit.prevent="submitCheckout">
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        ...
                        <button
                            ...
                            :disabled="store.checkoutProcessing || (!store.currentOrderItems.length && !store.selectedReservationId)"
                        >
                            {{ store.checkoutProcessing ? 'Bezig...' : (store.currentOrderItems.length ? 'Betaling bevestigen' : 'Uitchecken') }}
                        </button>
                    </div>
                </form>
            </div>
