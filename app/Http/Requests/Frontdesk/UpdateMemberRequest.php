...
class UpdateMemberRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'login' => ['nullable', 'string', 'max:255', Rule::unique('members', 'login')->ignore($memberId)->where(fn ($query) => $query->where('tenant_id', $tenantId))],
            ...
            'rfid_uid' => ['nullable', 'string', 'max:100', Rule::unique('members', 'rfid_uid')->ignore($memberId)->where(fn ($query) => $query->where('tenant_id', $tenantId))],
